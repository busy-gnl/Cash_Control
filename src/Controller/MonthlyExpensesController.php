...
class MonthlyExpensesController extends AbstractController
{
    ...
    public function index(MonthlyExpensesRepository $monthlyExpensesRepository): Response
    {
        return $this->render('monthly_expenses/index.html.twig', [
            'monthly_expenses' => $monthlyExpensesRepository->findAll(),
        ]);
    }
    ...
    public function edit(Request $request, MonthlyExpenses $monthlyExpense, MonthlyExpensesRepository $monthlyExpensesRepository): Response
    {
        $form = $this->createForm(MonthlyExpensesType::class, $monthlyExpense);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, MonthlyExpenses $monthlyExpense, MonthlyExpensesRepository $monthlyExpensesRepository): Response
    {
